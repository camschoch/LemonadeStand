...
namespace LemonadeStand
{
    public class UserInterface
    {
        ...
        private void SetNumberOfPitchers()
        {
        ...
        public void CallAllChoosingLemonade()
        {
            ChooseRecipe();
            SetAmmountOfIce();
            SetNumberOfPitchers();
